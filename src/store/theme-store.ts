...
export const useThemeStore = create(
  persist<ThemeState>(
    (set, get) => ({
      ...
      //   try {
      //     // const response = await Client.admin().get<Theme>("/themes");

      //     // const themeData = defaultVars;
      //     let theme: ThemeVars = {};
      //     let logo: string | undefined = undefined;
      //     let themePreset: ThemePresetInfo = null;
      ...
      //       themeData !== null
      //     ) {
      //       theme = themeData as ThemeVars;

      //       if ("logo" in themeData && typeof themeData.logo === "string") {
      //         logo = themeData.logo;
      //       }
      //       // Check for theme_preset in response

      //       if (
      //         "theme_preset" in themeData &&
      //         themeData.theme_preset &&
      //         typeof themeData.theme_preset === "object" &&
      //         !Array.isArray(themeData.theme_preset)
      //       ) {
      //         const preset = themeData.theme_preset as any;
      //         if (
